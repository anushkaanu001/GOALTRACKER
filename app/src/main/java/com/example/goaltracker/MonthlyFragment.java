...
public class MonthlyFragment extends Fragment {
    ...
    public static MonthlyFragment newInstance(int goalId) {
...
// THEN RecyclerView
        rvDaily = view.findViewById(R.id.rvMonthly);
        ...
        addTask.setOnClickListener(v -> {
            ...
            btnSave.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    task.setTaskType(TaskModel. MONTHLY);
                    ...
                    taskList.clear();
                    taskList.addAll(taskDao.getMonthlyTasks(goalId));
